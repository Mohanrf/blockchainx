...
ngOnInit(): void {
  ...
  this.meta.updateTag({
    name: 'keywords',
    content: 'top 5 mistakes to avoid built marketplace, building nft marketplace, create nft marketplace',
  });
  ...
  this.meta.updateTag({
    property: 'og:url',
    content: 'https://www.blockchainx.tech/6-mistakes-you-should-avoid-developing-nft-marketplace',
  });
  this.meta.updateTag({
  ...
  this.meta.updateTag({
    property: 'og:image',
    content: 'https://www.blockchainx.tech/assets-new/images/blog/Major-Mistakes-to-cuttoff-in-NFT-Marketplace.jpg',
  });
...
createLink() {
  ...
  link.setAttribute(
    'href',
    'https://www.blockchainx.tech/amp/6-mistakes-you-should-avoid-developing-nft-marketplace'
  );

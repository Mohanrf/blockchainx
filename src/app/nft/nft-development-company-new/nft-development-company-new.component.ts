...
@Component({
  selector: 'app-nft-development-company-new',
  templateUrl: './nft-development-company-new.component.html',
  styleUrls: ['./nft-development-company-new.component.css']
})
export class NftDevelopmentCompanyNewComponent implements OnInit {
  ...
  createLink() {
    ...
    link.setAttribute(
      'href',
      'https://www.blockchainx.tech/amp/nft-marketplace-development'
    );
